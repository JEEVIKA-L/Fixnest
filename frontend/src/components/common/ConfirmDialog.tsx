...
export const ConfirmDialog = ({
 ...
 className="bg-white dark:bg-[#1E293B] w-full max-w-sm rounded-3xl shadow-2xl relative z-10 overflow-hidden"
 >
 ...
 <h3 className="text-lg font-black text-[#1F2937] dark:text-gray-100 mb-2">{title}</h3>
 ...
 <button
 onClick={onCancel}
 className="flex-1 px-4 py-3 rounded-2xl text-sm font-bold text-[#1F2937]/50 bg-[#F6F7FB] dark:bg-[#0F172A] hover:bg-[#E5E7EB] transition-all"
 >
 {cancelLabel}
 </button>
 <button
