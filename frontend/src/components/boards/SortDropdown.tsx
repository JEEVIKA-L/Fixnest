...
export const SortDropdown = ({ onClose }: SortDropdownProps) => {
 ...
 className="absolute right-0 mt-2 top-full w-64 bg-white dark:bg-[#1E293B] border border-[#E5E7EB] dark:border-[#334155] rounded-2xl shadow-2xl z-[100] overflow-hidden flex flex-col"
 >
 <div className="p-4 border-b border-gray-50 bg-gray-50/30 flex items-center justify-between">
 <h3 className="text-xs font-black text-[#1F2937] dark:text-gray-100 uppercase tracking-widest">Sort Board</h3>
 {field !== 'manual' && (
 <button 
 onClick={resetSort}
 ...
 : 'hover:bg-gray-50 text-gray-600 dark:text-gray-400'
 }`}
 >
 ...
 order === ord 
 ? 'bg-white dark:bg-[#1E293B] text-[#6A3DE8] shadow-sm' 
