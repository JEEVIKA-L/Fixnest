...
export const ArchivedListsModal = ({ lists, onClose }: ArchivedListsModalProps) => {
 ...
 className="bg-white dark:bg-[#1E293B] w-full max-w-lg rounded-3xl shadow-2xl border border-[#E5E7EB] dark:border-[#334155] overflow-hidden"
 >
 ...
 <div>
 <h2 className="text-xl font-black text-[#1F2937] dark:text-gray-100">Archived Lists</h2>
 ...
 <div className="w-16 h-16 bg-[#F6F7FB] dark:bg-[#0F172A] rounded-full flex items-center justify-center mb-4">
 <Archive size={24} className="text-[#1F2937]/10" />
 </div>
 <h3 className="text-sm font-black text-[#1F2937] dark:text-gray-100">No archived lists</h3>
 ...
 <div 
 key={list.id}
 className="flex items-center justify-between p-4 bg-[#F6F7FB] dark:bg-[#0F172A] rounded-2xl border border-transparent hover:border-[#6A3DE8]/10 transition-all group"
 >
 <div>
 <h4 className="font-bold text-[#1F2937] dark:text-gray-100">{list.title}</h4>
 ...
 <div className="p-6 bg-[#F6F7FB]/50 border-t border-[#E5E7EB] dark:border-[#334155] flex justify-end">
 <button
 onClick={onClose}
 className="px-6 py-2.5 text-xs font-black uppercase tracking-widest text-[#1F2937] dark:text-gray-100 hover:bg-white rounded-xl border border-transparent hover:border-[#E5E7EB] transition-all"
 >
 Close
 </button>
 </div>
