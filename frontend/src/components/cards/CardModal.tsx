        ...
        >
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div 
              ...
              className="sticky top-0 z-20 pl-6 pr-10 py-6 border-b border-[#E5E7EB] backdrop-blur-md"
            >
              {/* Title row */}
                ...
                <div className="flex flex-col flex-1">
                  <div className="flex items-center gap-3">
                    ...
                    {isEditingTitle ? (
                      <input
                        autoFocus
                        className="text-xl font-black text-[#1F2937] bg-transparent border-b-2 border-[#6A3DE8] focus:outline-none w-full"
                        value={title}
                      ...
                      <h2 
                        ...
                        style={{ color: !isEditingTitle ? titleColor : undefined }}
                        className={`text-xl font-black ${!isCardCompleted ? 'cursor-pointer hover:bg-[#F6F7FB]' : ''} px-2 py-1 -ml-2 rounded-lg transition-all`}
                      >
                        {activeCard.title}
                      </h2>
                    )}
                  ...
                  {(() => {
                    ...
                    return (
                      <p className="ml-11 text-[10px] font-black text-[#1F2937]/50 uppercase tracking-widest mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
              ...
              <div className="md:col-span-3 space-y-10">
                      ...
                      {!isCardCompleted && (
                        <div className="relative ml-1">
                          <button
                            ...
                            className="w-8 h-8 rounded-full bg-[#F6F7FB] border-2 border-white flex items-center justify-center text-[#1F2937]/40 hover:text-[#6A3DE8] hover:bg-white transition-all ring-1 ring-gray-100"
                          >
                      ...
                      {!isCardCompleted && (
                        <div className="relative">
                          <button
                            ...
                            className="w-8 h-6 rounded bg-[#F6F7FB] flex items-center justify-center text-[#1F2937]/40 hover:text-[#6A3DE8] hover:bg-white transition-all border border-transparent hover:border-[#6A3DE8]/10 text-xs font-bold"
                          >
                            +
                          </button>
                    ...
                    <div className="relative inline-block">
                      {activeCard.dueDate ? (
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-[#1F2937]/40 bg-[#F6F7FB] hover:bg-[#E5E7EB] rounded-lg transition-all border border-dashed border-[#E5E7EB]"
                        >
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      <AlignLeft size={18} className="text-[#1F2937]/40" />
                      <h3 className="font-bold text-[#1F2937]">Description</h3>
                    </div>
                  ...
                  {isEditingDescription ? (
                    <div className="space-y-4">
                      <div className="bg-white border border-[#E5E7EB] rounded-2xl overflow-hidden shadow-sm transition-all focus-within:ring-2 focus-within:ring-[#6A3DE8]/10 focus-within:border-[#6A3DE8]">
                        {/* Editor Toolbar */}
                        <div className="flex items-center gap-1 p-2 bg-[#F6F7FB]/50 border-b border-[#E5E7EB]">
                          <button
                    ...
                    <div 
                      ...
                      className={`bg-[#F6F7FB] p-4 rounded-2xl border border-transparent ${!isCardCompleted ? 'hover:border-[#E5E7EB] cursor-pointer' : ''} transition-all group min-h-[100px]`}
                    >
                ...
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-bold text-[#1F2937]">Checklists</h3>
                  </div>
              ...
              <div className="md:col-span-2 space-y-6">
                ...
                {/* Activity / Comments */}
                <div className="bg-[#F6F7FB] rounded-2xl p-4 border border-[#E5E7EB]">
                  <div className="flex items-center gap-2 mb-4">
                    <MessageSquare size={15} className="text-[#6A3DE8]" />
                    <h3 className="text-sm font-black text-[#1F2937]">Activity</h3>
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <button 
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2 text-sm font-semibold text-[#1F2937]/70 bg-[#F6F7FB] hover:bg-[#E5E7EB] rounded-lg transition-all text-left"
                    >
                      <Copy size={14} />
                      Duplicate
                    </button>
                    ...
                    <button 
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2 text-sm font-semibold text-red-500 bg-[#F6F7FB] hover:bg-red-50 rounded-lg transition-all text-left"
                    >
                      <Trash2 size={14} />
                      Delete
                    </button>
                        ...
                        {reasonBy && (
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-[10px] font-bold text-[#1F2937]">{reasonBy.name}</p>
                            </div>
                          </div>
                        )}
                        {/* Reschedule date */}
