...
export const ChecklistSection = ({ cardId, checklists }: ChecklistSectionProps) => {
 ...
 <h3 className="font-bold text-[#1F2937] dark:text-gray-100">{checklist.title}</h3>
 </div>
 ...
 className="absolute top-full right-0 mt-1 w-60 bg-white dark:bg-[#1E293B] rounded-2xl shadow-2xl border border-[#E5E7EB] dark:border-[#334155] z-[200] overflow-hidden"
 >
 <div className="flex items-center justify-between p-3 border-b border-[#E5E7EB] dark:border-[#334155]">
 <span className="text-xs font-black text-[#1F2937] dark:text-gray-100">Assign Member</span>
 ...
 animate={{ opacity: 1, scale: 1, y: 0 }}
 exit={{ opacity: 0, scale: 0.95, y: -6 }}
 className="absolute top-full right-0 mt-1 w-56 bg-white dark:bg-[#1E293B] rounded-2xl shadow-2xl border border-[#E5E7EB] dark:border-[#334155] z-[200] p-4"
 >
 <p className="text-[10px] font-bold text-[#1F2937]/40 uppercase tracking-widest mb-3">Due Date</p>
 <input
 type="datetime-local"
 className="w-full border-2 border-[#E5E7EB] dark:border-[#334155] focus:border-[#6A3DE8] rounded-xl p-2 text-sm focus:outline-none"
 onChange={(e) => {
 ...
 <div className="flex-1 h-2 bg-[#F6F7FB] dark:bg-[#0F172A] rounded-full overflow-hidden border border-[#E5E7EB]/50">
 <motion.div 
 initial={{ width: 0 }}
 ...
 : 'border-[#E5E7EB] dark:border-[#334155] bg-white dark:bg-[#1E293B] hover:border-[#6A3DE8]'
 }`}
 >
 ...
 item.isCompleted ? 'text-[#1F2937]/40 line-through' : 'text-[#1F2937] dark:text-gray-100'
 }`}>
 {item.title}
 </span>
 ...
 {item.dueDate && (
 <span className="text-[10px] font-bold text-[#1F2937]/50 bg-[#F6F7FB] dark:bg-[#0F172A] border border-[#E5E7EB] dark:border-[#334155] px-2 py-0.5 rounded-full flex items-center gap-1.5 whitespace-nowrap">
 ...
 className="flex items-center gap-1 px-1.5 py-0.5 rounded-md border border-[#E5E7EB] dark:border-[#334155] bg-white dark:bg-[#1E293B] text-[9px] font-black text-[#1F2937]/60" 
 title={label.title}
 >
 ...
 animate={{ opacity: 1, scale: 1, y: 0 }}
 exit={{ opacity: 0, scale: 0.95, y: -6 }}
 className="absolute top-full right-0 mt-1 w-56 bg-white dark:bg-[#1E293B] rounded-2xl shadow-2xl border border-[#E5E7EB] dark:border-[#334155] z-[200] overflow-hidden"
 >
 <div className="flex items-center justify-between p-3 border-b border-[#E5E7EB] dark:border-[#334155]">
 <span className="text-xs font-black text-[#1F2937] dark:text-gray-100">Assign Member</span>
 ...
 animate={{ opacity: 1, scale: 1, y: 0 }}
 exit={{ opacity: 0, scale: 0.95, y: -6 }}
 className="absolute top-full right-0 mt-1 w-64 bg-white dark:bg-[#1E293B] rounded-2xl shadow-2xl border border-[#E5E7EB] dark:border-[#334155] z-[200] p-4"
 >
 ...
 className="w-full border-2 border-[#E5E7EB] dark:border-[#334155] focus:border-[#6A3DE8] rounded-xl p-2 text-xs focus:outline-none"
 ...
 >
 <div className="flex items-center justify-between p-3 border-b border-[#E5E7EB] dark:border-[#334155]">
 <span className="text-xs font-black text-[#1F2937] dark:text-gray-100">Labels</span>
 ...
 <span className="text-sm font-semibold text-[#1F2937] dark:text-gray-100">{label.title}</span>
 </div>
 ...
 className="w-full bg-white dark:bg-[#1E293B] border-2 border-[#6A3DE8] rounded-xl p-3 text-sm focus:outline-none shadow-lg shadow-[#6A3DE8]/5"
 value={newItemTitle}
 ...
 {isAddingChecklist ? (
 <div className="bg-white dark:bg-[#1E293B] border-2 border-[#6A3DE8] rounded-2xl p-4 shadow-xl shadow-[#6A3DE8]/5">
 <p className="text-xs font-black text-[#1F2937] dark:text-gray-100 mb-2">Checklist Title</p>
 <input
 autoFocus
 type="text"
 placeholder="e.g. Tasks, Review steps..."
 className="w-full bg-[#F6F7FB] dark:bg-[#0F172A] border border-[#E5E7EB] dark:border-[#334155] rounded-xl px-3 py-2 text-sm font-bold focus:outline-none focus:border-[#6A3DE8] transition-all mb-4"
 ...
 className="w-full flex items-center gap-3 px-4 py-3 text-sm font-bold text-[#1F2937]/40 bg-[#F6F7FB] dark:bg-[#0F172A] hover:bg-[#E5E7EB] hover:text-[#1F2937] rounded-2xl transition-all border border-dashed border-[#E5E7EB] dark:border-[#334155]"
 >
 <Plus size={16} />
 Add a checklist
 </button>
