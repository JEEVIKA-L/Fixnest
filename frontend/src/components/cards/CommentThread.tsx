...
export const CommentThread = ({ cardId, card }: CommentThreadProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-3 items-start">
        ...
        <div className="flex-1 min-w-0">
          <textarea
            ...
            className="w-full bg-[#F6F7FB] border border-[#E5E7EB] rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#6A3DE8]/20 focus:border-[#6A3DE8] outline-none transition-all resize-none"
            value={newText}
      ...
      {/* ── Feed ── */}
      {feed.length > 0 && <hr className="border-[#E5E7EB]" />}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 pt-0.5">
                    <p className="text-xs leading-snug">
                      <span className="font-black text-[#1F2937]">{user.name} </span>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-xs font-black text-[#1F2937]">{user.name}</span>
                  ...
                  {isEditing ? (
                    <div className="space-y-2">
                      <textarea
                        autoFocus
                        rows={2}
                        className="w-full bg-white border-2 border-[#6A3DE8] rounded-xl px-3 py-2 text-sm focus:outline-none resize-none"
                        value={editText}
                    ...
                    <>
                      <div className="bg-[#F6F7FB] px-3 py-2 rounded-xl border border-[#E5E7EB] text-sm text-[#1F2937]/80 leading-relaxed whitespace-pre-wrap break-words">
                        {comment.text}
                      </div>
