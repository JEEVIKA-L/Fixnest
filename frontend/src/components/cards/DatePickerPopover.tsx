...
export const DatePickerPopover = ({ cardId, currentDate, onClose }: DatePickerPopoverProps) => {
 ...
 <h3 className="text-sm font-black text-[#1F2937] dark:text-gray-100">Dates</h3>
 ...
 className="w-full pl-10 pr-4 py-2 bg-[#F6F7FB] dark:bg-[#0F172A] border border-[#E5E7EB] dark:border-[#334155] rounded-xl text-sm focus:outline-none focus:border-[#6A3DE8] transition-all"
 />
 </div>
 </div>
