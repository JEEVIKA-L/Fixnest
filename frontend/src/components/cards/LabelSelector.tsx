...
export const LabelSelector = ({ cardId, selectedLabelIds, onClose }: LabelSelectorProps) => {
 ...
 <h3 className="text-sm font-black text-[#1F2937] dark:text-gray-100">Labels</h3>
 ...
 isSelected ? 'border-[#6A3DE8] bg-[#6A3DE8]/5' : 'border-[#E5E7EB] dark:border-[#334155] hover:border-[#6A3DE8]/30 hover:bg-[#F6F7FB]'
 }`}
 >
