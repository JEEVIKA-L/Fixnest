...
export const OverdueDateDialog = ({ card, onClose, isReminder }: OverdueDateDialogProps) => {
 ...
 className="w-full max-w-md bg-white dark:bg-[#1E293B] rounded-3xl shadow-2xl border border-[#E5E7EB] dark:border-[#334155] overflow-hidden"
 >
 {/* Header */}
 ...
 className="w-full bg-[#F6F7FB] dark:bg-[#0F172A] border-2 border-[#E5E7EB] dark:border-[#334155] focus:border-red-400 rounded-2xl p-3 text-sm focus:outline-none transition-all resize-none"
 value={reason}
 ...
 className="w-full pl-10 pr-4 py-2.5 bg-[#F6F7FB] dark:bg-[#0F172A] border-2 border-[#E5E7EB] dark:border-[#334155] focus:border-red-400 rounded-2xl text-sm focus:outline-none transition-all"
 />
 </div>
 </div>
 ...
 <button
 onClick={onClose}
 className="flex-1 py-2.5 rounded-2xl text-sm font-bold text-[#1F2937]/50 bg-[#F6F7FB] dark:bg-[#0F172A] hover:bg-[#E5E7EB] transition-all"
 >
 Remind me later
 </button>
 )}
