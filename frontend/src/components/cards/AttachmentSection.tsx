...
export const AttachmentSection = ({ card }: AttachmentSectionProps) => {
 ...
 <h3 className="font-bold text-[#1F2937] dark:text-gray-100">Attachments</h3>
 </div>
 <label className="cursor-pointer bg-[#F6F7FB] dark:bg-[#0F172A] hover:bg-[#E5E7EB] px-3 py-1 rounded-lg text-xs font-bold text-[#1F2937]/70 transition-all flex items-center gap-2">
 <Plus size={14} />
 Add
 ...
 {/* Thumbnail */}
 <div className="w-24 h-20 rounded-xl overflow-hidden bg-white dark:bg-[#1E293B] border border-[#E5E7EB] dark:border-[#334155] flex-shrink-0 flex items-center justify-center relative shadow-sm">
 {at.type === 'image' ? (
 <img 
 src={at.url} 
 alt={at.name} 
 ...
 <span className="font-bold text-sm text-[#1F2937] dark:text-gray-100 truncate block flex-1">{at.name}</span>
 ...
 <div className="bg-[#F6F7FB]/50 border-2 border-dashed border-[#E5E7EB] dark:border-[#334155] rounded-2xl p-8 text-center">
